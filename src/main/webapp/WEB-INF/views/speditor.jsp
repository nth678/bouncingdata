...
<div id="main-content" class="editor-container">
  <div class="top-bar">
    <div class="left-buttons">
      <button id="editor-cancel"><a href="<c:url value="/anls/${anls.guid}" />" class="editor-nav" id="editor-cancel">Cancel</a></button>
    </div>
    <div class="editor-nav-panel">
      <button class="editor-nav" id="speditor-execute">Execute</button>
    </div>
    <div class="editor-progress progress" style="border: 0px;cursor: default;">
    </div>
  </div>
